    ...
    function Game(canvas, gameData) {
      ...
      function createInstructionView() {
        ...
        var panText = new createjs.Text(
          "buttons to move the puzzle around the board",
          "14px Arial Black",
          "#040707"
        );
        var zoomText = new createjs.Text(
          "buttons to zoom the puzzle in or out",
          "14px Arial Black",
          "#040707"
        );
        var resetText = new createjs.Text(
          "button to reset the puzzle grid to the starting position",
          "14px Arial Black",
          "#040707"
        );
        var questionText = new createjs.Text(
          "button to open or close the puzzle question window",
          "14px Arial Black",
          "#040707"
        );
        ...
        var garbageText = new createjs.Text(
          "button to clear your answer from the puzzle",
          "14px Arial Black",
          "#040707"
        );
        var helpText = new createjs.Text(
          "button to show this help screen",
          "14px Arial Black",
          "#040707"
        );
        var exitText = new createjs.Text(
      ...
      function initializeGame() {
        ...
        var loadingPhrases = [
          ...
          "Zombies are Making Corrections",
